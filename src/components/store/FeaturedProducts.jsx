    ...
    <section className="max-w-[1320px] mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-[#F3DE2C] rounded-sm p-8 flex flex-col items-center text-center relative overflow-hidden">
        ...
        <button 
          ...
          className="bg-clicon-orange text-white w-full py-4 rounded-sm font-bold uppercase text-sm flex items-center justify-center gap-2 mb-10 hover:bg-orange-600 transition"
        >
      ...
      <div className="lg:col-span-3">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-6 text-sm font-medium text-gray-400">
            ...
            <span onClick={() => navigate('/shop?cat=smartphone')} className="hover:text-black cursor-pointer transition">Smart Phone</span>
            <span onClick={() => navigate('/shop?cat=laptop')} className="hover:text-black cursor-pointer transition">Laptop</span>
            <span onClick={() => navigate('/shop?cat=headphone')} className="hover:text-black cursor-pointer transition">Headphone</span>
            <button 
              onClick={() => navigate('/shop')}
              className="text-clicon-orange flex items-center gap-1 font-semibold hover:gap-2 transition-all"
            >
...
const StandardCard = ({ id, tag, badge, name, price, oldPrice, rating, image, onClick }) => (
  <div 
    onClick={onClick}
